...
::: incremental
-   Microscopic and free floating aquatic plants

-   Do not have ability to move

-   They possess chlorophyll-*a*
:::
...
1.  Assessing the relationship between global warming and SST around coastal areas in Tanzania
:::

::: {.fragment .fade-in-then-semi-out}
2.  Determination of the long-term changes in chlorophyll-*a* in territorial waters of Tanzania
:::

::: {.fragment .fade-in-then-semi-out}
3.  Investigating the vertical variation in chlorophyll-*a* and temperature along the water column in Tanzanian waters
:::

::: {.fragment .fade-in-then-semi-out}
4.  Assessing changes in global warming indices and their effects in phytoplankton biomass
:::
...
## GAM between Chl-a & environmental variable {.scrollable}
...
::: {.column width="20%"}
-   SST&air temp. influence Chl-*a* -vely

-   Discharge & precipitation had +ve relationship with Chl-*a*
:::
:::

##  {background-image="images/gam-zanzibar2.png"}
